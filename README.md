...
[![Test](https://github.com/heilgar/file-storage-adapter/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/heilgar/file-storage-adapter/actions/workflows/test.yml) [![Latest Release](https://github.com/heilgar/file-storage-adapter/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/heilgar/file-storage-adapter/actions/workflows/npm-publish.yml)
